...
function renderGraphicDesignCourses() {
    const graphicDesignCourses = courses.filter(course => course.category === "Web-development");
    console.log(courses)

    const courseContainer = document.getElementById("web-dev-related-courses-section");

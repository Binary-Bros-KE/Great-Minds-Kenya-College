...
function renderGraphicDesignCourses() {
    const graphicDesignCourses = courses.filter(course => course.category === "architecture");
    console.log(courses)

    const courseContainer = document.getElementById("architecture-related-courses-section");

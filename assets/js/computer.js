...
function renderGraphicDesignCourses() {
    const graphicDesignCourses = courses.filter(course => course.category === "computer-packages");
    console.log(courses)

    const courseContainer = document.getElementById("computer-related-courses-section");

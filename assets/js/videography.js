...
function renderGraphicDesignCourses() {
    const graphicDesignCourses = courses.filter(course => course.category === "Videography");
    console.log(courses)

    const courseContainer = document.getElementById("videography-related-courses-section");
